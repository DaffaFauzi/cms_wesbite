<header class="bg-white/60 backdrop-blur-md border-b border-slate-200/40 sticky top-0 z-20 transition-all"
        style="backdrop-filter: blur(6px);">
    <div class="w-full px-4 md:px-6 xl:px-8 h-14 flex items-center justify-between gap-4">
        ...
        <div class="hidden flex-1 justify-center md:flex min-w-0">
            <div class="w-full max-w-xl min-w-0">
                <div class="relative group">
                    ...
                    <input type="text" placeholder="Search everything (⌘K)" class="block w-full pl-9 pr-3 py-2 border border-transparent rounded-lg bg-white/5 text-slate-800 placeholder-slate-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-indigo-500/15 focus:border-indigo-500 transition-all sm:text-sm shadow-sm">
